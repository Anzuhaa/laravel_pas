        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="" class="flex items-center justify-between mr-4">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Anzuhaa</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <button type="button"
                    ...
                    <img class="w-8 h-8 rounded-full"
                        src="https://i.pinimg.com/control2/736x/4b/fa/b6/4bfab6455fbe95fdee083389cd76886f.jpg"
                        alt="user photo" />
                </button>
                <!-- Dropdown menu -->
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    id="dropdown">
                    <div class="py-3 px-4">
                        <span class="block text-sm font-semibold text-gray-900 dark:text-white">Anzuhaa</span>
                        <span class="block text-sm text-gray-900 truncate dark:text-white">Anzuhaa@gmail.com</span>
                    </div>
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-pages"
                        class="py-2 space-y-2 {{ request()->is('studentsadmin') || request()->is('gradesadmin') || request()->is('departmentsadmin') ? 'block' : 'hidden' }}">
                        <li>
                            <a href="/studentsadmin"
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700
                                {{ request()->is('studentsadmin') ? 'active' : '' }}">Students</a>
                        </li>
                        <li>
                            <a href="/gradesadmin"
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700
                                {{ request()->is('gradesadmin') ? 'active' : '' }}">Grade</a>
                        </li>
                        <li>
                            <a href="/departmentsadmin"
                                class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700
                                {{ request()->is('departmentsadmin') ? 'active' : '' }}">Department</a>
                        </li>
                    </ul>
            </ul>
            </li>
